...
public class MainPanel extends JPanel {
	...
	//use backupsCells
	if (_backupCells[leftX][upY].getAlive())    { numNeighbors++; }
	if (_backupCells[leftX][downY].getAlive())  { numNeighbors++; }
	if (_backupCells[leftX][y].getAlive())      { numNeighbors++; }
	if (_backupCells[rightX][upY].getAlive())   { numNeighbors++; }
	if (_backupCells[rightX][downY].getAlive()) { numNeighbors++; }
	if (_backupCells[rightX][y].getAlive())     { numNeighbors++; }
	if (_backupCells[x][upY].getAlive())        { numNeighbors++; }
	if (_backupCells[x][downY].getAlive())      { numNeighbors++; }
	...
	//use backup cells instead
	boolean alive = _backupCells[x][y].getAlive();
